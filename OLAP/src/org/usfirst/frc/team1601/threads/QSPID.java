 ...
 *
 * @author Darvin
 * Basic PID Control algorithm check drive thread. Some of this code from Simbotics. 
 */
public class QSPID {
    ...
    public QSPID(double p, double i, double d, double eps) {
        this.pConst = p;
        this.iConst = i;
        this.dConst = d;
    ...
    public QSPID(double p, double i, double d) {
        this(p, i, d, 1.0);
    }
    ...
    public double calcPID(double currentVal) {
        ...
        //limit the output
        output = Functions.limitValue(output, this.maxOutput);
